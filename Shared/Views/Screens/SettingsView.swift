        ...
        NavigationView{
            ScrollView(.vertical, showsIndicators: false, content:  {
                ...
                GroupBox(label: SettingsLabelView(labelText: "Profile", labelImage: "person.fill")  , content: {
                    ...
                    //JWD: PROFILE PICTURE
                    NavigationLink(
                        destination: SettingsEditImageView(title: "Profile Picture", description: "Your profile picture will be seen on your profile and on your posts", selectedImage: UIImage(named:"dog1")!),
                                   label:  {
...
//                    SettingsRowView(leftIcon: "figure.walk", text: "Sign Out", color: Color.MyTheme.orangeColor)
                ...
                GroupBox(label: SettingsLabelView(labelText: "Application Information", labelImage: "app.iphone"), content: {
                    Button(action: {
                        openCustomURL(urlString: "https://www.googlke.com")
                    }, label: {
